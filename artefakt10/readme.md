...
* **Wniosek:** Docker daje izolację środowiska, łatwy deployment i eliminuje problem w którym coś działa tylko jednej osobie.
...
* **Wniosek:** Analiza statyczna pozwala wykryć podatności, nadmiarowe uprawnienia i potencjalnie niebezpieczny kod bez uruchamiania aplikacji.

### 🔹 BLOK 3-4: Fundamenty Skryptowania (Python for QA)
Budowa logiki testowej w języku Python.
* **Co zrobiono:** Nauka list, słowników, pętli, funkcji, klas, wyjątków oraz pracy z danymi JSON.
...
* **Co zrobiono:** Używanie selektorów ID i XPath oraz symulowanie kliknięć, wpisywania tekstu, scrollowania i nawigacji po aplikacji.
